...
public class Message implements Writable {
	...
	public LongWritable getTrussID() {
		return trussID;
	}

	public void setTrussID(LongWritable trussID) {
	...
	public void readFields(DataInput in) throws IOException {
		...
		if(type.equals(Type.TRUSS_ID)) {
			trussID = new LongWritable();
			trussID.readFields(in);
		}
